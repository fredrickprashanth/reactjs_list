    ...
    render: function() {
        return (
            React.createElement("tr", null, 
                ...
                React.createElement("input", {type: "hidden", value: this.props.name, ref: "name"}), 
                React.createElement("td", null, " ", React.createElement("a", {href: "", className: "uk-icon-hover uk-icon-minus-square", onClick: this.handleOnClick}), " ")
            )
        );
    }
});
...
var ListAdd = React.createClass({displayName: "ListAdd",
    ...
    render: function() {
        return (
                React.createElement("tr", null, 
                    React.createElement("td", null, " ", React.createElement("input", {type: "text", placeholder: "name", ref: "name"}), " "), 
                    React.createElement("td", null, " ", React.createElement("input", {type: "text", placeholder: "description", ref: "desc"}), " "), 
                    React.createElement("td", null, " ", React.createElement("a", {href: "", className: "uk-icon-hover uk-icon-plus-square", onClick: this.onClick}), " ")
                )
        );
    }
});
...
var List = React.createClass({displayName: "List",
    ...
    render: function() {
        ...
        var ListItemNodes = items.map(function(item) {
            return (
                React.createElement(ListItem, {name: item.name, desc: item.desc, handleRemove: this.handleRemoveItem})
            );
        }, this);
        return (
            React.createElement("table", {className: "uk-table uk-table-hover"}, 
                React.createElement("tbody", null, 
                    ListItemNodes, 
                    React.createElement(ListAdd, {handleAdd: this.handleAddItem})
                )
            )
        );
   }
...
React.render(
        React.createElement(List, {url: "item/list"}),
